...
import com.swp391_be.SWP391_be.exception.CustomAccessDeniedHandler;
import com.swp391_be.SWP391_be.exception.CustomAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, CustomAccessDeniedHandler customAccessDeniedHandler, CustomAuthenticationEntryPoint customAuthenticationEntryPoint) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/users","/api/auth","/swagger-ui/**", "/v3/api-docs/**" ,"/api/material/**").permitAll()
